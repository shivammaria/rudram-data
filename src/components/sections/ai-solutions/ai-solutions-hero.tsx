...
import content from "@/app/content/ai-solutions.json";
  ...
  return (
    <section className="relative w-full py-32 lg:py-48 text-center overflow-hidden">
      <div className="absolute inset-0 w-full h-full z-0">
         ...
         <Bot className="absolute top-1/4 left-1/4 h-32 w-32 text-primary/10 animate-float" style={{ animationDelay: '1s'}} />
         <Zap className="absolute bottom-1/4 right-1/4 h-32 w-32 text-accent/10 animate-float" />
      </div>
